...
/***/ function(module, exports, __webpack_require__) {
	...
	var Search = React.createClass({
	    ...
	    componentWillMount: function componentWillMount() {
	        ...
	        helpers.search(searchData).then(function (data) {
	            this.setState({
	    ...
	    render: function render() {
	        return React.createElement(
	            ...
	            React.createElement(
	                'div',
	                { className: 'row' },
	                React.createElement(Results, { results: this.state.data, meta: this.state.meta })
	            )
	        );
	    },
	                ...
	                React.createElement(
	                    ...
	                    React.createElement(
	                        ...
	                        React.createElement(
	                            ...
	                            React.createElement("input", { type: "text", className: "form-control ", id: "search_topic", ref: "text" }),
	                            React.createElement(
	                                "h4",
	                                { className: "" },
	                                React.createElement(
	                            ...
	                            React.createElement("input", { type: "text", className: "form-control ", id: "search_start", ref: "begin" }),
	                            React.createElement(
	                                "h4",
	                                { className: "" },
	                                React.createElement(
